...
# parser.add_argument('--lr', type=float, default=0.001/3000)
parser.add_argument('--lr', type=float, default=0.01/100)
...
parser.add_argument('--seg_weight', type=float, default=20,
...
parser.add_argument('--dual_weight', type=float, default=1,
...
parser.add_argument('--pointwise', default=False, action='store_true')
...
parser.add_argument('--bs_step', type=int, default=4)
...
def main():
    ...
    '''
    args.snapshot = 'D:/github_desktop/tutorial/GSCNN/iou_0.40387_gn_60epoch_segloss50.76214_edgloss_43.17_segweight10_edgeweight20.pth'
    # args.snapshot = 'D:/github_desktop/tutorial/GSCNN/best_epoch_28_mean-iu_0.24590_30epoch.pth'
    # args.snapshot = 'D:/github_desktop/tutorial/GSCNN/best_cityscapes_checkpoint.pth'
...
def train(train_loader, net, criterion, optimizer, curr_epoch, writer):
    ...
    for i, data in enumerate(train_loader):
        ...
        if args.joint_edgeseg_loss:
            ...
            if args.seg_weight > 0: #是否启用segloss
            ...
            if args.edge_weight > 0:  #是否启用edgeloss
        ...
        if args.local_rank == 0:
            ...
            temp  = optimizer.param_groups[-1]['lr']
            logging.info(msg)
